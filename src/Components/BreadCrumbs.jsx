...
export const BreadCrumbs = ({links}) => {
    return(
        <section className="w-full center">
            <div className="bor der border- blue w-11/12 lg:w-10/12 xl:w-9/12 flex justify-start items-center p-3 pl-[20px] p-9 lg:pl-[50px] rounded-full mb-[10vh] flex-wrap shadow-xl ">
                {
                    links.map((link, i) => (
                        i == 0 ?
