    ...
    return(
        <main className="center flex-col min-h-screen z-10 w-full gap-9">
            ...
            <section className="center gap-[5vh] mt-[9vh] relative w-full min-h -[70vh] overflow-hidden">
                ...
                <div className="w-11/12 lg:w-10/12 flex items-center justify-start text-white my-[10vh]">
            ...
            <section className="w-11/12 lg:w-10/12 flex flex-col gap-[5vh] my-[9vh]">
                ...
                <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-9 md:gap-3 xl:gap-9">
                    {
